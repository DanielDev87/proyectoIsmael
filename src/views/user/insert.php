...
$placeholders = [':username', ':password'];  // Placeholders para el SQL
$form_fields = ['username', 'password']; // Los campos del formulario que se corresponden con las columnas
        ...
        <?php foreach ($form_fields as $field): ?>
            <div class="mb-3">
                ...
                <?php if ($field === 'password'): ?>
                    <!-- Campo de contraseña, tipo 'password' para que sea secreto -->
                    <input type="password" class="form-control" id="<?php echo $field; ?>" name="<?php echo $field; ?>" required>
                <?php elseif ($field === 'university_id' && isset($universities)): ?>
