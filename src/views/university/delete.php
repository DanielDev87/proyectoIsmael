...
$table = 'universities';  // Nombre de la tabla (puede cambiarse por cualquier otra tabla)
$primaryKey = 'id';  // Nombre de la columna primaria (puede ser 'id' o cualquier otra columna que identifique el registro)
